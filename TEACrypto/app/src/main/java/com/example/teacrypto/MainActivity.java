...
import com.example.teacrypto.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Used to load the 'tea' library on application startup.
    static {
    ...
    /**
     * A native method that is implemented by the 'teacrypto' native library,
