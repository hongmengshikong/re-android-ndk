...
/**
* @Encodes input (unsigned long) into output (md5_byte).
*
* @param {input} usigned long.
*
* @param {output} md5_byte.
*
* @param {length} the length of input.
*
*/
void MD5::encode(const bit32* input, md5_byte* output, size_t length) {
...
/**
 * @Decodes input (md5_byte) into output (usigned long).
 *
 * @param {input} bytes.
 *
 ...
 *
 */
void MD5::decode(const md5_byte* input, bit32* output, size_t length) {
    for (size_t i = 0, j = 0; j < length; ++i, j += 4) {
